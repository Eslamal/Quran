package com.eslamali.elquranelkarim.elquranelkarim.ui.fragment.homeCycle.quranCycle;
...
import com.eslamali.elquranelkarim.elquranelkarim.adapter.QuranDetailsAdapter;
...
public class QuranDetailsFragment extends BaseFragment {
    ...
    private void getData() {
        try {
            JSONObject obj = new JSONObject(HelperMethod.AssetJSONFile("QuranDetails.json", getActivity()));
